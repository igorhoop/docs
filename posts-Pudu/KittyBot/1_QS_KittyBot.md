...
![PuduQRIOS](/assets/images/PuduQR_app_ios.png){: width="150px" height="150px" style="display: inline; margin: 20px 15px; margin-inline: 10%; margin-inline-start: 33%"}
![PuduQRAndroid](/assets/images/PuduQR_app_android.png ){: width="150px" height="150px" caption="Android" style="display: inline; margin: 20px 15px; margin-inline: 10%; margin-inline-end: 33%"}
