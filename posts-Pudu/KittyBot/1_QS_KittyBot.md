...
![PuduQRIOS](/assets/images/PuduQR_app_ios.png){: width="150px" height="150px" style="display: inline; margin-left: auto;
  margin-right: auto"}
![PuduQRAndroid](/assets/images/PuduQR_app_android.png ){: width="150px" height="150px" caption="Android" style="display: inline; margin-left: auto;  margin-right: auto"}
